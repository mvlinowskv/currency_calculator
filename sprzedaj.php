...
foreach($xml->children() as $waluty) {
    ...
    echo "<td>", $waluty->kurs_sredni . "</td></tr> ";
        ...
        <div class="container-right">
            <form action="sprzedaj.php" method="post" class="form-calculator">
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
        <label class="btn btn-secondary btn_2">
            <input type="radio" name="options" id="option1" autocomplete="off" ><a href="pow.php"> Wykup</a>
  </label>
  <label class="btn btn-secondary active btn_2">
      <input type="radio" name="options" id="option2" autocomplete="off" checked>Sprzedaj
                </label></div>
   ...
   <p>Zmień na:<select class="waluty form-control" name="waluty" id="waluta-select" style="width:250px;">
        ...
        <option value="CN" nae="CNY">Yuan Renminbi (Chiny)</option>   
             ...
             @($money = $_POST['money']);
               ...
               foreach($xml->children() as $waluty) {
                   if ($waluta == $waluty->kod_waluty) {
                       ...
                       echo "Ilość pieniędzy: ", bcmul($money, $kurs_2, 2),  " ", "PLN";       
